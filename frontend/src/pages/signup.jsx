    ...
    <div style={{ fontFamily: 'Poppins, sans-serif' }} className="min-h-screen bg-white p-6 flex items-center justify-center relative">
      ...
      <div className="bg-white border-2 border-[#0F2C4E] shadow-lg rounded-2xl p-8 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#0F2C4E] mb-2">Crear Cuenta</h1>
          <p className="text-[#0F2C4E]/80">
            Únete a nosotros y comienza tu aventura
          </p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="lastName" className="block text-sm font-medium text-[#0F2C4E] mb-2">
                Apellido
              </label>
              <input
                type="text"
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-[#0F2C4E] mb-2">
          ...
          <div>
            <label htmlFor="userType" className="block text-sm font-medium text-[#0F2C4E] mb-2">
              ¿Qué eres?
            </label>
            <select
              id="userType"
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3 text-sm">
              <label htmlFor="terms" className="text-[#0F2C4E]">
                Acepto los{' '}
                <a href="#" className="font-medium text-[#0F2C4E] hover:text-[#FFC72C] transition-colors underline">
          ...
          <button
            type="submit"
            className="w-full bg-[#FFC72C] text-[#0F2C4E] py-3 px-4 rounded-lg font-bold hover:opacity-90 transition-all duration-300 transform hover:scale-105"
          >
            Crear Cuenta
          </button>
        </form>
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-[#0F2C4E]/60">O regístrate con</span>
            </div>
          </div>
        </div>
