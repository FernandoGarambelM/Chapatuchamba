...
export default function Login() {
  ...
  function handleFacebookLogin() {
    // Placeholder para login con Facebook
        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            {!showEmailForm ? (
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <span className="text-neutral-700 font-medium">Continuar con Google</span>
                </button>
                ...
                >
                  ...
                  <span className="text-neutral-700 font-medium">Continuar con Facebook</span>
                </button>
                ...
                >
                  ...
                  <span className="text-neutral-700 font-medium">Continuar con email</span>
                </button>
              </div>
            ) : (
            ...
            <div className="mt-6 text-center">
              <span className="text-neutral-600">¿Aún no tienes cuenta? </span>
              <Link 
                to="/register" 
